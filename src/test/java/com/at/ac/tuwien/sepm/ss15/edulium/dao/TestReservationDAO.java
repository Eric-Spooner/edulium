...
public class TestReservationDAO extends AbstractDAOTest {
    ...
    public void testPopulate_shouldReturnFullyPopulatedObjectsOfDeletedObjects() throws DAOException, ValidationException {
        ...
        assertEquals(0, reservationDAO.find(reservation1).size());
        ...
        assertEquals(1, reservationDAO.find(reservation2).size());
        reservationDAO.delete(reservation2);
        assertEquals(0, reservationDAO.find(reservation2).size());
        ...
        reservationDAO.create(reservation3);
        assertEquals(1, reservationDAO.find(reservation3).size());
        reservationDAO.delete(reservation3);
        assertEquals(0, reservationDAO.find(reservation3).size());
    ...
    public void testPopulate_listWithNullObjectsShouldThrow() throws DAOException, ValidationException {
        // GIVEN
        List<Reservation> invalidReservations = new ArrayList<>();
        invalidReservations.add(null);
