            ...
            public void handle(MouseEvent t) {
                if(createTable) {
                    if(numberTF.getText().isEmpty()) {
                        ...
                        Rect rect = new Rect(((((int) t.getX()) - TABLE_SIZE / 2) / FACT) * FACT, ((((int) t.getY()) - TABLE_SIZE / 2) / FACT) * FACT, TABLE_SIZE, TABLE_SIZE, null, Long.valueOf(numberTF.getText()), interiorService);
