MERGE INTO RestaurantUser (ID, name, userRole, tip) KEY(ID) VALUES ('cook', 'Crusty Cook', 'ROLE_COOK', 1);
MERGE INTO RestaurantUser (ID, name, userRole, tip) KEY(ID) VALUES ('waiter', 'Wily Waiter', 'ROLE_SERVICE', 2);
MERGE INTO RestaurantUser (ID, name, userRole, tip) KEY(ID) VALUES ('manager', 'Maverick Manager', 'ROLE_MANAGER', 3);
